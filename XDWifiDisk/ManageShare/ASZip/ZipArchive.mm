...
-(BOOL) UnzipFileTo:(NSString*) path overWrite:(BOOL) overwrite
{
	...
	do{
        ...
        NSString *tmpStr = [[NSString alloc] initWithCString:filename encoding:gbkEncoding];
        NSString * strPath = [[[NSString alloc] initWithString: tmpStr] autorelease];
        [tmpStr release];
        ...
        {
            NSStringEncoding gbkEncoding = CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000);
            strPath = [[[NSString alloc]initWithCString:filename encoding:gbkEncoding] autorelease];
        }*/
        NSLog(@"strPath1---%@\n", strPath);
